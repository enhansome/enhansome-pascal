...
* [Alcinoe](http://sourceforge.net/projects/alcinoe) ([mirror at GH](https://github.com/Zeus64/alcinoe) ⭐ 1,126 | 🐛 35 | 🌐 Pascal | 📅 2026-09-08). `[Delphi]` Library of visual and non-visual components for Delphi.
...
* [QuickLib](https://github.com/exilon/QuickLib) ⭐ 715 | 🐛 42 | 🌐 Pascal | 📅 2026-05-08. `[Delphi]` `[FPC]` Quick development library (AutoMapper, LinQ, IOC Dependency Injection, MemoryCache, Scheduled tasks, Config, Serializers, Json Serialize, Chronometer, Threads, Lists, Config, Console services etc) with crossplatform support for Delphi/Firemonkey (Windows,Linux,macOS/IOS/Android) and freepascal (Windows/Linux).
...
* [CNVCL](https://github.com/cnpack/cnvcl) ⭐ 405 | 🐛 5 | 🌐 Pascal | 📅 2026-09-09. `[Delphi]` CnPack Component Package. Large collection of visual components, classes and utilities. // *Lots of useful stuff; documentation and comments mainly in Chinese*

* [MARS - Curiosity](https://github.com/andrea-magni/MARS) ⭐ 394 | 🐛 24 | 🌐 Pascal | 📅 2026-08-21. `[Delphi]` Delphi REST Library. Pure REST approach, standard concepts in a familiar Delphi flavor (including a component based client library). Known compatibility: Delphi versions from XE to 10 Seattle. Some functionalities requires FireDAC.
...
* [Skia4Delphi](https://github.com/viniciusfbb/skia4delphi) ⭐ 781 | 🐛 47 | 🌐 Pascal | 📅 2026-09-02. `[Delphi]` Cross-platform 2D graphics API for Delphi platforms based on Google's Skia Graphics Library. It provides a comprehensive 2D API that can be used across mobile, server and desktop models to render images.
...
* [PdfiumLib](https://github.com/ahausladen/PdfiumLib) ⭐ 206 | 🐛 10 | 🌐 Pascal | 📅 2026-05-30. `[Delphi]` Example of a PDF VCL Control using PDFium

* [Vampyre Imaging Library](https://github.com/galfar/imaginglib) ⭐ 151 | 🐛 17 | 🌐 Pascal | 📅 2026-08-05. `[Delphi]` `[FPC]` Cross-platform native Object Pascal (Delphi and Free Pascal) image loading, saving, and manipulation library.
...
* [dexif](https://github.com/cutec-chris/dexif) ⭐ 23 | 🐛 7 | 🌐 Pascal | 📅 2025-12-01. `[Delphi]` `[FPC]` Lazarus port of Delphi EXIF Library to extract Exif Information from Images
...
* [Castle Game Engine](https://github.com/castle-engine/castle-engine) ⭐ 1,242 | 🐛 87 | 🌐 Pascal | 📅 2026-09-10. `[Delphi]` `[FPC]` Complete Pascal Game Engine. Cross-platform 3D and 2D game engine with a lot of graphic effects and a scene graph based on X3D.

* [pasvulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 226 | 🐛 13 | 🌐 Pascal | 📅 2026-09-09. `[Delphi]` `[FPC]` Vulkan header generator, OOP-style API wrapper, framework and prospective Vulkan-based game engine for Object Pascal.
...
* [Ray4Laz](https://github.com/GuvaCode/Ray4Laz) ⭐ 177 | 🐛 1 | 🌐 Pascal | 📅 2026-08-09. `[FPC]` A complete header translation (binding) of [raylib](https://www.raylib.com/) to Pascal.

* [Kraft Physics Engine](https://github.com/BeRo1985/kraft) ⭐ 130 | 🐛 7 | 🌐 Pascal | 📅 2026-09-09. `[Delphi]` `[FPC]` Open source Object Pascal physics engine library that can be used in 3D games. Compatible with: Delphi 7-XE7 (but not with the Android and iOS targets), FreePascal >= 2.6.2 (with almost all FPC-supported targets including Android and iOS)
...
* [Delphi3D Engine](https://github.com/BrokenGamesUG/delphi3d-engine) ⭐ 80 | 🐛 0 | 🌐 Pascal | 📅 2021-01-21. `[Delphi]` A 3D-graphic and game engine for Delphi and Windows

* [ImGui-Pascal](https://github.com/Coldzer0/ImGui-Pascal) ⭐ 79 | 🐛 1 | 🌐 Pascal | 📅 2025-08-19. `[Delphi]` `[FPC]` ImGui-Pascal is [ImGui](https://github.com/ocornut/imgui) ⭐ 76,145 | 🐛 1,228 | 🌐 C++ | 📅 2026-09-10 binding (crossplatform GUI lib) with the latest version & docking. Support Windows, Linux, OSX.
...
* [Horse](https://github.com/HashLoad/horse) ⭐ 1,374 | 🐛 0 | 🌐 Pascal | 📅 2026-09-10. `[Delphi]` `[FPC]` Fast and minimalist web framework. Horse allows to create powerful RESTful servers without effort. Focused on microservices.
...
* [RESTRequest4Delphi](https://github.com/viniciussanchez/RESTRequest4Delphi) ⭐ 620 | 🐛 0 | 🌐 Pascal | 📅 2026-09-03. `[Delphi]` RESTRequest4Delphi is a API to consume REST services written in any programming language. Designed to facilitate development, in a simple and minimalist way.

* [Indy](https://github.com/IndySockets/Indy) ⭐ 556 | 🐛 302 | 🌐 Pascal | 📅 2026-07-08. `[Delphi]` `[FPC]` Network components for Delphi, C++Builder, Delphi.NET, and FreePascal
  // *All-in-one network library based on blocking sockets and threads. Included in default RAD studio installation since 2006.*

* [Delphi JOSE and JWT Library](https://github.com/paolo-rossi/delphi-jose-jwt) ⭐ 519 | 🐛 4 | 🌐 Pascal | 📅 2026-08-23. `[Delphi]` Delphi implementation of JOSE (JSON Object Signing and Encryption) and JWT (JSON Web Token)

* [Delphi Cross Socket](https://github.com/winddriver/Delphi-Cross-Socket/) ⭐ 471 | 🐛 64 | 🌐 Pascal | 📅 2026-09-06. `[Delphi]` `[FPC]` Delphi/FPC cross platform socket library (Chinese). Uses different IO models for different platforms: IOCP (Windows), KQUEUE (FreeBSD(macOS, iOS, etc)), EPOLL (Linux(Linux, Android)). Supports TCP, HTTP/HTTPS, WebSocket with SSL/TLS.
...
* [Delphi IOCP](https://github.com/ymofen/diocp-v5) ⭐ 253 | 🐛 7 | 🌐 Pascal | 📅 2026-04-22. `[Delphi]` Implements several network classes based on Windows IOCP technology. Socket, HTTP, Ntrip servers and clients.
...
* [Daraja Framework](https://github.com/michaelJustin/daraja-framework) ⭐ 160 | 🐛 4 | 🌐 Pascal | 📅 2026-09-10. `[Delphi]` `[FPC]` Lightweight HTTP server framework for Object Pascal (Delphi 2009+ / Free Pascal 3.0). Implementing RESTful services is supported via the [daraja-restful](https://github.com/michaelJustin/daraja-restful) ⚠️ Archived extension.
...
* [STOMP Client](https://github.com/danieleteti/delphistompclient) ⭐ 146 | 🐛 25 | 🌐 Pascal | 📅 2022-03-23. `[Delphi]` `[FPC]` STOMP client for Embarcadero Delphi and FreePascal. The project can use INDY (Delphi) or Synapse (Delphi or FreePascal).
...
* [Kastri](https://github.com/DelphiWorlds/Kastri) ⭐ 597 | 🐛 4 | 🌐 Pascal | 📅 2026-09-07. `[Delphi]` Cross-platform library which builds upon the existing RTL and FMX libraries in Delphi. Supports a number of newer APIs that you won't find in FMX/RTL, and "backfills" for missing APIs
...
* [ATTabs](https://github.com/Alexey-T/ATFlatControls) ⭐ 110 | 🐛 1 | 🌐 Pascal | 📅 2026-08-27. `[Delphi]` `[FPC]` Delphi/Lazarus component for lite tabs. OS independent, fully custom drawn.
...
* [ATSynEdit](https://github.com/Alexey-T/ATSynEdit) ⭐ 192 | 🐛 4 | 🌐 Pascal | 📅 2026-09-10. `[FPC]` Multi-line editor control for Lazarus including syntax highlighting.
...
* [HtmlViewer](https://github.com/BerndGabriel/HtmlViewer) ⭐ 444 | 🐛 91 | 🌐 Pascal | 📅 2026-07-19. `[Delphi]` `[FPC]` Delphi/Lazarus HtmlViewer/FrameViewer.
  // *Html visualiser supporting majority of tags, inline styles and CSS.*

* [WebView4Delphi](https://github.com/salvadordf/WebView4Delphi) ⭐ 405 | 🐛 10 | 🌐 Pascal | 📅 2026-08-28. `[Delphi]` `[FPC]` Project to embed Chromium-based browsers in applications made with Delphi or Lazarus/FPC for Windows.
...
* [ATViewer](https://sourceforge.net/projects/atviewer) ([mirror at GitHub](https://github.com/Alexey-T/ATViewer) ⭐ 47 | 🐛 0 | 🌐 Pascal | 📅 2018-12-14). `[Delphi]` Delphi components to view various file types: text, binary, images, multimedia, webpages, etc.
...
* [ATImageMap](https://sourceforge.net/projects/atviewer/files/ATImageMap) ([mirror at GitHub](https://github.com/Alexey-T/ATViewer) ⭐ 47 | 🐛 0 | 🌐 Pascal | 📅 2018-12-14). `[Delphi]` Component designed to show many images (parts of the whole image) as a single map. For example, you may have array of images, 200 by X, and 100 by Y and control will show them as a single map. Component also allows to draw paths: each path consists of many lines, points, and icons.

* [ATBinHex for Delphi](https://github.com/Alexey-T/ATViewer/blob/master/Source/ATBinHex.pas) ⭐ 47 | 🐛 0 | 🌐 Pascal | 📅 2018-12-14. `[Delphi]`, [ATBinHex for Laz](https://github.com/Alexey-T/ATBinHex-Lazarus) ⭐ 23 | 🐛 2 | 🌐 Pascal | 📅 2025-09-10. `[FPC]` Viewer for files of unlimited size like in Total Commander.

* [ATImageBox for Delphi](https://github.com/Alexey-T/ATViewer/blob/master/Source/ATImageBox.pas) ⭐ 47 | 🐛 0 | 🌐 Pascal | 📅 2018-12-14. `[Delphi]`, [ATImageBox for Laz](https://github.com/Alexey-T/ATImageBox-Lazarus) ⭐ 8 | 🐛 1 | 🌐 Pascal | 📅 2023-12-10. `[FPC]` TScrollBox with embedded TImage. Control can auto position image inside.
...
* [iORM](https://github.com/mauriziodm/iORM) ⭐ 58 | 🐛 0 | 🌐 Pascal | 📅 2026-09-07. `[Delphi]`  Delphi ORM interface based useful to develop desktop and mobile application.
...
* [sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx) ⭐ 14,708 | 🐛 615 | 🌐 C++ | 📅 2026-09-10. `[Delphi]` `[FPC]` Speech-to-text, text-to-speech, speaker diarization, speech enhancement, source separation, and VAD using next-gen Kaldi with onnxruntime without Internet connection. Support embedded systems, Android, iOS, HarmonyOS, Raspberry Pi, RISC-V, RK NPU, Ascend NPU, x86\_64 servers, websocket server/client, support 12 programming languages

* [CAI Neural API](https://github.com/joaopauloschuler/neural-api) ⭐ 438 | 🐛 59 | 🌐 Pascal | 📅 2026-09-04. `[FPC]` Pascal-based deep learning neural network API optimized for AVX, AVX2 and AVX512 instruction sets plus OpenCL capable devices including AMD, Intel and NVIDIA. This API has been tested under Windows and Linux.
...
* [FWZip](https://github.com/AlexanderBagel/FWZip) ⭐ 65 | 🐛 1 | 🌐 Pascal | 📅 2026-08-01. `[Delphi]` Classes to work with Zip archives using Store and Deflate methods, supports ZIP64, DataDescryptors, PKWARE encryption, NTFS attributes, Utf8 in filenames.
...
* [dataset-serialize](https://github.com/viniciussanchez/dataset-serialize) ⭐ 743 | 🐛 2 | 🌐 Pascal | 📅 2026-08-03. `[Delphi]` `[FPC]` This component is a JSON serializer for the DataSet component. Allows you to convert JSON to DataSet, DataSet to JSON, and export and load the structure of DataSet fields in JSON format. Compatible with VCL projects, FMX and uniGUI (framework).
...
* [FastMM4-AVX](https://github.com/maximmasiutin/FastMM4-AVX) ⭐ 155 | 🐛 1 | 🌐 Pascal | 📅 2026-08-26. `[Delphi]` `[FPC]` FastMM4 fork with AVX support and multi-threaded enhancements (faster locking)
...
* [Delphi64RTL](https://github.com/RDP1974/Delphi64RTL) ⭐ 48 | 🐛 0 | 🌐 Pascal | 📅 2026-07-24. `[Delphi]` Object Pascal wrappers from Intel Integrated Performance Primitives and Intel Threading Building Blocks royalty-free packages. Includes lock-free scalable allocator, simd enabled rtl subset routines (memory fill, copy, compare) and accelerated zlib compression
...
* [CAI NEURAL API](https://github.com/joaopauloschuler/neural-api) ⭐ 438 | 🐛 59 | 🌐 Pascal | 📅 2026-09-04. `[FPC]` `[Delphi]` Cross-platform Neural Network API optimized for AVX, AVX2 and AVX512 instruction sets plus OpenCL capable devices including AMD, Intel and NVIDIA.
...
* [TRegExpr](https://github.com/andgineer/TRegExpr) ⭐ 193 | 🐛 16 | 🌐 Pascal | 📅 2026-07-08. `[Delphi]` `[FPC]` Regular expressions engine in pure Object Pascal.
...
* [PasMP](https://github.com/BeRo1985/pasmp) ⭐ 123 | 🐛 4 | 🌐 Pascal | 📅 2026-07-02. `[Delphi]` `[FPC]` Parallel-processing/multi-processing library for Object Pascal.
...
* [FLRE](https://github.com/BeRo1985/flre) ⭐ 103 | 🐛 41 | 🌐 Pascal | 📅 2026-05-01. `[Delphi]` `[FPC]` FLRE ( F ast L ight R egular E xpressions) is a fast, safe and efficient regular expression library, which is implemented in Object Pascal (Delphi and Free Pascal) but which is even usable from other languages like C/C++ and so on.
...
* [Pascal](https://github.com/alefragnani/vscode-language-pascal) ⭐ 272 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-05 and [Pascal Formatter](https://github.com/alefragnani/vscode-pascal-formatter) ⭐ 38 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-05. Open source extensions created for Visual Studio Code that add Pascal support.
...
* [Delphi.gitignore](https://github.com/github/gitignore) ⭐ 175,697 | 🐛 74 | 📅 2026-09-08. .gitignore templates for Delphi. There is also one for Lazarus.

* [Boss](https://github.com/HashLoad/boss) ⭐ 625 | 🐛 19 | 🌐 Go | 📅 2026-09-03. Dependency Manager for Delphi projects.
